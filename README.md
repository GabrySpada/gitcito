...
| **[Staging](docs/help/staging.md)** | Whole files, hunks, or **individual lines** — hover a line and click **+**, GitKraken-style; unstage lines the same way. |
...
| **[Repositories](docs/help/repositories.md)** | Every repository Gitcito knows about, open or not — favourites, recents and folders you scan, in one searchable page. Read any one's README in a drawer before you open it. Point it at your code folder and it offers to turn each subfolder into a workspace. |
